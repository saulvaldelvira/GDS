...
The function "Comparator.compare_literal_integer" takes two void pointers, casts them to literal integers and compares them.
 ...
 ```
Since intptr_t is the largest data type than can be safely casted this way, this function can be used for ints, longs and chars. Basically any integer-like data type that is smaller than a pointer.
