...
bool compare_float(void *e_1, void *e_2){
    float f_1 = * (float *) e_1;
    int   i_1 = f_1 * Comparators.float_precision;

    float f_2 = * (float *) e_2;
    int   i_2 = f_2 * Comparators.float_precision;
    if (i_1 > i_2){
        return 1;
    }else if (i_2 > i_1){
        return -1;
...
bool compare_double(void *e_1, void *e_2){
    ...
    int i_1 = d_1 * Comparators.double_precision;

    double d_2 = * (double *) e_2;
    int i_2 = d_2 * Comparators.double_precision;
...
void set_float_precision(int num_decimals){
        Comparators.float_precision = pow(10, num_decimals);
}

void set_double_precision(int num_decimals){
        Comparators.double_precision = pow(10, num_decimals);
}